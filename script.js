...
// We check if an app is already initialized to prevent errors
...
let currentStudentList = []; // Used for local filtering/search
...
function renderStudents(students) {
    ...
    if (students.length === 0) {
        tbody.innerHTML = '<tr><td colspan="4" style="text-align:center; padding:20px;">No students registered in this module.</td></tr>';
        return;
    }
